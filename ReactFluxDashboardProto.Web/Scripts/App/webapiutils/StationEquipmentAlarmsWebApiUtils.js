...
/** @const */
var ROUTE = "/api/equipmentalarms/";

var StationEquipmentAlarmsWebApiUtils = {
    ...
    getEquipmentAlarms: function(station) {
        ...
        $.ajax({
            ...
            ServerActionCreators.receivedEquipmentAlarms(station, alarms);
...
module.exports = StationEquipmentAlarmsWebApiUtils;